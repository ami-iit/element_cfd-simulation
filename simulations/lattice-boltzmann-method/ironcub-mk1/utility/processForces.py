...
ax1.plot(time, [CdA_avg]*len(time), label=r'$(C_DA)_{avg}=$'+"{:.3f}".format(CdA_avg), color='red')
...
ax2.plot(time, [ClA_avg]*len(time), label=r'$(C_LA)_{avg}=$'+"{:.4f}".format(ClA_avg), color='red')
...
ax3.plot(time, [CsA_avg]*len(time), label=r'$(C_SA)_{avg}=$'+"{:.4f}".format(CsA_avg), color='red')
...
ax1.plot(time, [CrAl_avg]*len(time), label=r'$(C_rAl)_{avg}=$'+"{:.4f}".format(CrAl_avg), color='red')
...
ax2.plot(time, [CpAl_avg]*len(time), label=r'$(C_pAl)_{avg}=$'+"{:.4f}".format(CpAl_avg), color='red')
...
ax3.plot(time, [CyAl_avg]*len(time), label=r'$(C_yAl)_{avg}=$'+"{:.4f}".format(CyAl_avg), color='red')
