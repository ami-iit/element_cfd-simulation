...
saveFolderName = 'data_post/plots/sideslip/';
...
%         scatter(linkAoAs,linkClAs,[],linkSsAs); hold on;
%         xlabel('$\alpha_{link}$','Interpreter','latex');
...
%         scatter(linkAoAs,linkCsAs,[],linkSsAs); hold on;
%         xlabel('$\alpha_{link}$','Interpreter','latex');
...
%         fig = figure(linkIndex);
%         scatter(linkAoAs,sqrt(linkClAs.^2 + linkCsAs.^2 + linkCdAs.^2),[],linkSsAs); hold on;
%         xlabel('$\alpha_{link}$','Interpreter','latex');
