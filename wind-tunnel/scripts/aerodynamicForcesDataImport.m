...
for testIndex = 1:length(testList(:,1))
    ...
    windAxesAero.rollTorque  = - bodyAero.xTorque .*cosd(state.alphaMeas).*cosd(state.betaMeas) ...
                               + bodyAero.yTorque .*sind(state.betaMeas) ...
                               + bodyAero.zTorque .*sind(state.alphaMeas).*cosd(state.betaMeas);
    windAxesAero.pitchTorque = + bodyAero.xTorque .*cosd(state.alphaMeas).*sind(state.betaMeas) ...
                               + bodyAero.yTorque .*cosd(state.betaMeas) ...
                               - bodyAero.zTorque .*sind(state.alphaMeas).*sind(state.betaMeas);
    windAxesAero.yawTorque   = - bodyAero.xTorque .*sind(state.alphaMeas) ...
