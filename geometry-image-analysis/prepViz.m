function [Visualizer,Objects]=prepViz(KinDynModel,meshFilePrefix,interp_fun,axis_limits,varargin)
...
for it=1:numberOfLinks
    ...
    [meshHandles(it,:),transforms(it)]=plotMeshInWorld(linkMeshInfo(it),w_H_link,interp_fun,varargin{:});
...
% ylabel('{y}');
% zlabel('{z}');
set(gca,'XLim',axis_limits(1:2))
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'XColor','none')
set(gca,'YLim',axis_limits(3:4))
set(gca,'ytick',[])
set(gca,'yticklabel',[])
set(gca,'YColor','none')
set(gca,'ZLim',axis_limits(5:6))
set(gca,'ztick',[])
set(gca,'zticklabel',[])
set(gca,'ZColor','none')
set(gca,'Color','none')
